...
For this assignment, you'll create a website by using visualizations that were created in using Python-APIs, or you can use the [weather data](Resources/cities.csv) provided.
